...
/***/ function(module, exports, __webpack_require__) {
	...
	var DependencyInjector = function DependencyInjector(props) {
	  var DIR = function (_React$Component) {
	    _inherits(DIR, _React$Component);
	    ...
	    DIR.prototype.getChildContext = function getChildContext() {
	      return (0, _propUtils.reduceProps)(this.props);
	    };

	    DIR.prototype.render = function render() {
	  ...
	  DIR.childContextTypes = (0, _propUtils.mapPropTypesToProps)(props);

	  return _react2["default"].createElement(DIR, props);
	};
