const teams = {
    ...
    gen2: {
      ...
      { name: 'Espeon', type1: 'Psychic', moveset:['Psychic','Hidden Power Water','Morning Sun','Growth'], item:'Leftovers', sprite:'https://www.pokencyclopedia.info/sprites/gen2/spr_gold/spr_g_196.png' },
    ...
    gen3: {
      ...
      { name: 'Swellow', type1: 'Normal', type2:'Flying', ability:'Guts', nature: 'Jolly', item:'Choice Band', Evs:'4 HP/ 252 Atk/ 252 Spe', moveset:['Aerial Ace','Return','Hidden Power Fighting','Facade'], sprite:'https://www.pokencyclopedia.info/sprites/gen3/ani_emerald/ani_e_277.gif' },
    ...
    gen4: {
      ...
      { name: 'Luxray', type1: 'Electric', ability:'Intimidate', nature: 'Naughty', item:'Life Orb', Evs:'204 Atk/ 156 SpA/ 148 Spe', moveset:['Thunderbolt','Crunch','Superpower', 'Ice Fang'], sprite:'https://www.pokencyclopedia.info/sprites/gen4/spr_diamond-pearl/spr_dp_405_m-2.png' },
    ...
    gen5: {
      ...
      { name: 'Lilligant', type1: 'Grass', ability:'Chlorophyll', nature: 'Timid', item:'Life Orb/Lum Berry', Evs:'4 HP/ 252 SpA/ 252 Spe', moveset:['Quiver Dance','Sleep Powder','Giga Drain','Hidden Power Fire'], sprite:'https://www.pokencyclopedia.info/sprites/gen5/ani_black-white/ani_bw_549.gif' },
    ...
    gen7: {
      ...
      { name: 'Salazzle', type1: 'Poison', type2:'Fire', ability:'Oblivious', nature: 'Timid', item:'Poisonium Z', Evs:'8 HP/ 248 SpA/ 252 Spe', moveset:['Nasty Plot','Sludge Wave','Fire Blast','Hidden Power Ice'], sprite:'https://www.pokencyclopedia.info/sprites/3ds/ani_7_shiny/3ani_-S_758__sm.gif' },
